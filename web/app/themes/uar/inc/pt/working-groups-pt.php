...
function workgroups_post_type() {

	$labels = array(
		'name'                  => _x( 'Working Groups', 'Post Type General Name', 'uar' ),
		'singular_name'         => _x( 'Working Group', 'Post Type Singular Name', 'uar' ),
		'menu_name'             => __( 'Working Groups', 'uar' ),
		'name_admin_bar'        => __( 'Working Groups', 'uar' ),
	...
	$args = array(
		'label'                 => __( 'Working Groups', 'uar' ),
		'description'           => __( 'Working Groups post type', 'uar' ),
		'labels'                => $labels,
    'show_in_rest' => true,
	...
	register_post_type( 'working-groups', $args );

}
add_action( 'init', 'workgroups_post_type', 0 );
