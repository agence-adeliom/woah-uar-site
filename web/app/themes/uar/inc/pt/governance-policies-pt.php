...
function governance_post_type() {

	$labels = array(
		'name'                  => _x( 'Governance & Policies', 'Post Type General Name', 'uar' ),
		'singular_name'         => _x( 'Governance & Policies', 'Post Type Singular Name', 'uar' ),
		'menu_name'             => __( 'Governance & Policies', 'uar' ),
		'name_admin_bar'        => __( 'Governance & Policies', 'uar' ),
	...
	$args = array(
		'label'                 => __( 'Governance & Policies', 'uar' ),
		'description'           => __( 'Governance & Policies post type', 'uar' ),
		'labels'                => $labels,
    'show_in_rest' => true,
	...
	register_post_type( 'governance-policies', $args );

}
add_action( 'init', 'governance_post_type', 0 );
