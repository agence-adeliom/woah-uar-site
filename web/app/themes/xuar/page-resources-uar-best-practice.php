...
<div class="container-fluid post-list">
  <div class="container post-list-head p-0">
    ...
    <div class="buttons row no-gutters">
      ...
      <div class="col-md col-6"><a class="active" href="/resources-uar-best-practice#list"><span>UAR Best Practice</span></a></div>
    </div>
  </div>
...
<?php
  ...
  $args = array (
  	'post_type'              => array( 'uar-best-practice' ),
  ...
  // The Loop
  if ( $practice->have_posts() ) {?>

<div class="container p-0">
  <?php	while ( $practice->have_posts() ) {
  		$practice->the_post();?>
...
<div class="paging">
 <?php wp_pagenavi( array( 'query' => $practice ) );?></div>
