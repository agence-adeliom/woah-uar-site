...
?>
  <div class="col-auto im-switch "><p>Images: <?php echo $checkp;?></p><label class="switch">
    <input class="imagestate" type="checkbox" <?php if(isset($_SESSION['imagestate'])){ if( $_SESSION['imagestate'] == "off"){?>checked<?php } }?>>

    <span class="slider round"></span>
  </label></div>
  <div class="col lang "></div>
  <div class="col-auto search "><a id="searchopen" href="#"></a>
    <div id="searchblock"><form action="/" method="get" class="row search-bar no-gutters">
...
<div class="row h-100 justify-content-between">
    ...
    <div class="quick-links col-md-4 col-6 p-0">
      <div class="row utils no-gutters">
        <div class="col lang "></div>
        <div class="col im-switch "><p>Images: <?php echo $checkp;?></p><label class="switch">
          <input class="imagestate" type="checkbox"
          <?php if(isset($_SESSION['imagestate'])){ if( $_SESSION['imagestate'] == "off"){?>checked<?php } }?>>
          <span class="slider round"></span>
        </label></div>
      </div>
