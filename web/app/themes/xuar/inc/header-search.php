...
<div class="row h-100 justify-content-between">
    <div class="logo"><a  href="/home"><?php //include (TEMPLATEPATH . '/media/logo-uar.php');?><span>United Against Rabies</span></a></div>
    <div class="quick-links col-4 p-0">
      <div class="row utils no-gutters">
        <div class="col lang "></div>
        <div class="col im-switch "><p>Images ON / OFF </p><label class="switch">
