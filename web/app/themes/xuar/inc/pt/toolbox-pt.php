...
function strategy_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Programs and Strategies', 'Taxonomy General Name', 'uar' ),
		'singular_name'              => _x( 'Program and Strategy', 'Taxonomy Singular Name', 'uar' ),
		'menu_name'                  => __( 'Program and Strategy', 'uar' ),
		'all_items'                  => __( 'All Items', 'uar' ),
...
function vaccination_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Dog Vaccination', 'Taxonomy General Name', 'uar' ),
		'singular_name'              => _x( 'Dog Vaccination', 'Taxonomy Singular Name', 'uar' ),
		'menu_name'                  => __( 'Dog Vaccination', 'uar' ),
		'all_items'                  => __( 'All Items', 'uar' ),
		'parent_item'                => __( 'Parent Item', 'uar' ),
		'parent_item_colon'          => __( 'Parent Item:', 'uar' ),
		'new_item_name'              => __( 'New Item Name', 'uar' ),
...
function surveillance_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Surveillance', 'Taxonomy General Name', 'uar' ),
		'singular_name'              => _x( 'Surveillance', 'Taxonomy Singular Name', 'uar' ),
		'menu_name'                  => __( 'Surveillance', 'uar' ),
		'all_items'                  => __( 'All Items', 'uar' ),
		'parent_item'                => __( 'Parent Item', 'uar' ),
		'parent_item_colon'          => __( 'Parent Item:', 'uar' ),
		'new_item_name'              => __( 'New Item Name', 'uar' ),
