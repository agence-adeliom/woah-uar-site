...
<div class="container-fluid post-list">
  <div class="container post-list-head">
    ...
    <div class="buttons row no-gutters">
      ...
      <div class="col"><a class=" <?php if (isset($flink)){?>active<?php }?>"href="<?php echo get_the_permalink()?>?type=event&future=yes#list"><span>Future Events</span></a></div>
      <div class="col"><a class=" <?php if (isset($plink)){?>active<?php }?>"href="<?php echo get_the_permalink()?>?type=event&past=yes#list"><span>Past Events</span></a></div>
      <div class="col"><a class=" <?php if (isset($clink)){?>active<?php }?>" href="<?php echo get_the_permalink()?>?type=course#list "><span>Courses</span></a></div>
